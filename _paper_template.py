...
LISTEN = [
    ...
    {"script": "W: I lost my bank card on the bus this morning. What should I do first? M: Don't panic. Call the bank's hotline right away to freeze the account so nobody can use the card. W: And then? M: Visit any branch with your ID to apply for a replacement. It usually takes about a week.",
     "q": "What should the woman do FIRST?",
     "opts": [("A","Wait one week"),("B","Call the bank to freeze the account"),("C","Visit a branch immediately"),("D","Buy a new card online")],
     "ans": "B", "exp": "Call the bank's hotline right away to freeze。"},
    {"script": "M: I got two internship offers — one at a bank, one at a tech startup. Which would you pick? W: Depends on what you want. The bank pays better and looks great on a resume, but the startup gives you real responsibility from day one. M: I think I'd grow faster at the startup. W: Then trust that instinct.",
     "q": "Which internship does the man lean toward?",
     "opts": [("A","Bank, for the pay"),("B","Startup, for faster growth"),("C","Neither"),("D","Both part-time")],
     "ans": "B", "exp": "I'd grow faster at the startup。"},
    {"script": "W: Are you signing up for the English speech contest? M: I'd love to, but my topic is still vague. W: The deadline is Friday. Pick anything you genuinely care about — judges spot fake enthusiasm immediately. M: Maybe I'll talk about my grandfather's village losing young people. That actually moves me.",
     "q": "What advice does the woman give about the topic?",
     "opts": [("A","Pick a popular topic"),("B","Choose something you genuinely care about"),("C","Memorize a famous speech"),("D","Speak about technology")],
     "ans": "B", "exp": "Pick anything you genuinely care about。"},
    {"script": "M: My final exam in statistics overlaps with the literature paper deadline. I'm stressed. W: Have you talked to either professor? M: Not yet. I thought I should solve it myself. W: That's the wrong instinct. Professors usually offer extensions if you explain in advance, but not the night before.",
     "q": "What is the woman's main point?",
     "opts": [("A","Solve it alone"),("B","Communicate with professors in advance"),("C","Drop one course"),("D","Skip the exam")],
     "ans": "B", "exp": "Professors offer extensions if you explain in advance。"},
    {"script": "W: I'm writing my graduate school personal statement and it feels stiff. M: Show, don't tell. Instead of writing 'I am passionate about research', tell the moment a research result actually surprised you. W: That makes sense. Specific stories beat general adjectives. M: Exactly. Admissions officers read thousands of statements that say 'I am passionate'.",
     "q": "What writing advice does the man give?",
     "opts": [("A","Use more adjectives"),("B","Show through specific stories"),("C","Write longer paragraphs"),("D","Quote famous scholars")],
     "ans": "B", "exp": "Show, don't tell + Specific stories beat general adjectives。"},
    {"script": "M: I'm thinking of dropping my Tuesday morning class. W: Why? You signed up because the professor's research matches your interest. M: True, but I'm exhausted after staying up reading the assignment. W: The problem isn't the class, it's that you postpone the reading. Move it to Saturday.",
     "q": "What does the woman identify as the real problem?",
     "opts": [("A","The class is boring"),("B","Postponing the reading to the last night"),("C","The professor is too strict"),("D","Tuesday morning is too early")],
     "ans": "B", "exp": "The problem isn't the class, it's that you postpone the reading。"},
    {"script": "W: My roommate plays music loudly until midnight. I haven't slept well in a week. M: Have you told her directly that it bothers you? W: I dropped a few hints, but she didn't get them. M: Hints don't work. Talk to her plainly when you're both calm — most roommate problems come from indirect communication.",
     "q": "What does the man recommend?",
     "opts": [("A","Move out"),("B","Talk plainly when both are calm"),("C","Send a strongly worded text"),("D","Report to the dorm advisor")],
     "ans": "B", "exp": "Talk to her plainly when you're both calm。"},
]
